...
- **Interface Inteligente:** Layout "Inspector" otimizado para desktop e dispositivos móveis com suporte a blur (glassmorphism).
...
1. **Upload:** Clique no botão superior para carregar seu arquivo `.mesh` ou `.rbxm`.
2. **Inspecionar:** Use o mouse (ou toque) para orbitar, dar zoom e pan no modelo.
3. **Ajustar:** - Mude a cor no painel lateral.
   - Defina o valor em graus e rotacione nos eixos coloridos (Vermelho para X, Verde para Y, Azul para Z).
4. **Exportar:** Clique em **OBJ** ou **GLTF** para baixar o modelo convertido pronto para uso no Blender, Unity ou Roblox.
...
<p align="center">
  <img src="preview.png" width="300" alt="Texto Alternativo">
  &nbsp; <img src="preview2.png" width="300" alt="Texto Alternativo">
</p>
